...
\Shorttitle{\fme: inverse modelling, sensitivity, Monte Carlo -
...
%\VignetteIndexEntry{Sensitivity, calibration, identifiability, Monte Carlo analysis of a nonlinear model}
...
<<>>=
print(system.time(
MCMC <- modMCMC(f=Residuals,p=P$par,jump=Covar,niter=3000, ntrydr=3,
