...
%\VignetteIndexEntry{Sensitivity, calibration, identifiability, Monte Carlo analysis of a steady-state model}
...
condition of oxygen. Function \code{steady.band} from package \pkg{rootSolve} ( \citep{rootSolve})
